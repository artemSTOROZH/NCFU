...
class Roman:
    ...
    def __add__(self, other):
        ...
        if isinstance(other, int):
            result = self.arabic + other
        else:
            result = self.arabic + other.arabic
    ...
    def __check_roman(value):
        ...
        for input_letter in value:
            for valid_letter in Roman.LETTERS:
                if input_letter == valid_letter:
                    break
                elif valid_letter == Roman.LETTERS[len(Roman.LETTERS) - 1]:
                    raise ValueError
    ...
    def to_arabic(roman):
        ...
        def letter_to_number(letter):
            ...
            for letter_position in range(0, len(Roman.LETTERS)):
                if letter == Roman.LETTERS[letter_position]:
                    return Roman.NUMBERS[letter_position]
